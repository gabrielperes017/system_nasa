...
export const orbitalElements = {
    kepler440b: {
    semiMajorAxis: 114_000_000, // em km, ~0.76 AU convertido
    eccentricity: 0.0, // excentricidade assumida (desconhecida)
    inclination: THREE.MathUtils.degToRad(0), // desconhecida
    longitudeOfAscendingNode: THREE.MathUtils.degToRad(0), // desconhecida
    argumentOfPeriapsis: THREE.MathUtils.degToRad(0), // desconhecida
    meanAnomalyAtEpoch: THREE.MathUtils.degToRad(0), // desconhecida
    epoch: 2451545.0, // mesmo epoch de referência
    link: 'https://upload.wikimedia.org/wikipedia/commons/0/09/Kepler-440b.jpg',
    name: 'Kepler-440b',
    sizeOf: '1.86', // raio estimado em relação à Terra
    distance: '1.135 light-years', // distância de ~1.135 mil anos-luz
    descricao: `Kepler-440b é um exoplaneta potencialmente rochoso localizado a aproximadamente 1.135 anos-luz da Terra, na constelação de Lyra. Foi descoberto em 2015 pelo telescópio espacial Kepler. Possui um raio cerca de 1,86 vezes o da Terra e orbita dentro da zona habitável de sua estrela anã laranja, Kepler-440. Seu ano dura cerca de 101 dias terrestres. Devido à distância e limitações de observação, ainda há muitas incertezas quanto à sua composição atmosférica e condições reais de superfície.`,
    description: `Kepler-440b is a potentially rocky exoplanet located approximately 1,135 light-years from Earth in the constellation Lyra. It was discovered in 2015 by the Kepler Space Telescope. It has a radius about 1.86 times that of Earth and orbits within the habitable zone of its host orange dwarf star, Kepler-440. Its orbital period is approximately 101 Earth days. Due to its distance and observational limitations, much remains uncertain about its atmospheric composition and surface conditions.`
},
